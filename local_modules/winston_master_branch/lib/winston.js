...
module.exports.version = "1.0.0-lm";
...
// update: nexe compatibility.
function NexeIncludeReferences() {
    require('./winston/transports/transport.js');
    require('./winston/transports/console.js');
    require('./winston/transports/file.js');
    require('./winston/transports/http.js');
    require('./winston/transports/memory.js');
}
